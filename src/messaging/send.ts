...
function generateClientId(prefix: string = "weixin-bot"): string {
...
export async function sendMessageWeixin(params: {
  ...
  const clientId = generateClientId(opts.clientIdPrefix);
...
export async function sendMediaItems(params: {
  ...
  for (const item of items) {
    lastClientId = generateClientId(opts.clientIdPrefix);
