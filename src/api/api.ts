...
let _channelVersionOverride: string | undefined;
export function setChannelVersion(v: string): void { _channelVersionOverride = v; }

function readChannelVersion(): string {
  if (_channelVersionOverride) return _channelVersionOverride;
  try {
